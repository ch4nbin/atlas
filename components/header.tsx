    ...
    <header className="relative z-20 px-4 pt-4 sm:px-6 sm:pt-6">
      <div className="mx-auto w-full max-w-6xl rounded-full border border-white/40 bg-white/20 backdrop-blur-xl shadow-[0_8px_30px_rgba(20,20,20,0.16)]">
        <div className="flex items-center justify-between px-3 py-2 sm:px-4">
          ...
          <Link
            href="/explore"
            className="h-9 px-6 rounded-full bg-black/90 text-white text-xs sm:text-sm font-medium hover:bg-black transition-colors duration-200 cursor-pointer inline-flex items-center"
          >
            Begin
          </Link>
        </div>
