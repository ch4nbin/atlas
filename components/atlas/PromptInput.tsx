...
const LIBRARY_MAPS: MapData[] = [
  ...
  { id: 'medieval-castle', title: 'Medieval Castle', track: 'humanities', icon: '🏰', era: '1150 CE', region: 'England', shortDescription: 'Norman motte-and-bailey.', longDescription: 'Explore a Norman castle — great hall, chapel, armory, bailey market — as it appeared in the mid-twelfth century.', worldId: '7e486a4a-abe4-4505-b9d9-923ec54ac10b', sceneLabel: 'Medieval Castle', wash: 'linear-gradient(135deg,#9aa4b0,#5b6775 55%,#2b3540)' },
  ...
  { id: 'japanese-edo', title: 'Japanese Edo Period', track: 'humanities', icon: '⛩️', era: '1700 CE', region: 'Edo (Tokyo)', shortDescription: 'Tokugawa-era street life.', longDescription: 'Explore Edo under the Tokugawa shogunate. Kabuki theatre, woodblock workshop, samurai estate, merchant quarter.', worldId: '7e486a4a-abe4-4505-b9d9-923ec54ac10b', sceneLabel: 'Japanese Edo Period', wash: 'linear-gradient(135deg,#d1b0b8,#8a4d5a 55%,#3e1a25)' },
  // ── STEM ────────────────────────────────────────────────────────────
...
export function PromptInput({ mode }: PromptInputProps) {
  ...
  const handleEnterMap = (map: MapData) => {
    ...
    if (map.track === 'humanities') {
      void loadWorldById(map.worldId, map.sceneLabel);
    } else {
